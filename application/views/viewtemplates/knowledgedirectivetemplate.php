 <div> 
	 <div ng-repeat = "offer_has_knowledge in offer_has_knowledges"> 
	 	<div> {{offer_has_knowledge.knowledgeName}} <span ng-click="deleteKnowledge(offer_has_knowlege)"> x </span>	 </div>  		 	
	 </div>
	 
	 {{offer_has_knowledges.knowledgeName}}
	 ...
	 <div ng-show="search.knowledge" ng-repeat = "knowledge in knowledges | filter:search.knowledge"> 
	 	<div ng-click="addKnowledge(knowledge.knowledgeName)"> {{knowledge.knowledgeName}} </div>  			 	
	 </div>
 </div>