...
<html lang="es" ng-app="app">
	<head>
		<meta charset="UTF-8" />
		<link rel="stylesheet" type="text/css" media="(min-width: 575px)" href="/job-bank/css/index.css">
		<link rel="stylesheet" type="text/css" media="(max-width: 574px)" href="/job-bank/css/index2.css">
